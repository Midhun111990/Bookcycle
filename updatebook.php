...
$update="UPDATE addbook SET bookname='$bookname', bookauthor='$bookauthor', bookpublication='$bookpublication', bookstatus='$bookstatus', bookedition='$bookedition', bookcategory='$bookcategory',bookprice='$bookprice', bookcopies='$bookcopies', bookdescription='$bookdescription',bookyearofpub='$bookyearofpub' WHERE id=".$_GET['id'];
...
<tr><td align="center"><a href="viewbook.php"><button type="button" value="button">Cancel</button></a></center></td>
</tr>
</center>
</table>
</form>
