  ...
  <nav class="navbar mynav navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Book Cycling System</a> </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="#">Home</a></li>
          <li><a href="addlibrary.php">Add Library</a></li>
          <li><a href=".php">Add Librarian</a></li>
          <li><a href=".php">View Libraries</a></li>
          <li><a href=".php">View Users</a></li>
          <li><a href=".php">Book List</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="banner-text">
            <h2>Book Cycling<span>System</span></h2>
            <p>Book's are a uniquely portable <span>Magic</span></p>
          </div>
        </div>
      </div>
    </div>
