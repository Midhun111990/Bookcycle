...
if(isset($_POST['btnlogin']))
{
	...
	$res=mysqli_query($con,"select *from addlibrarian where email='$uname' and password='$pass'");
      ...
      <table width="200" border="0" cellpadding="10" cellspacing="0" align="center">
        <tr>
          ...
          <td> <div class="form-group"><label for="txtname"></label>
            <input type="text" name="txtname" id="txtname" required="required" title=" Your E-mail" /></div>
            </td>
          </tr>
        <tr>
