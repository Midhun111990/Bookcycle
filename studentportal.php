    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="borrowstudent.php">Borrow</a></li>
          <li><a href="fine-student.php">Fines</a></li>
         <li><a href="lendstudent.php">Lend</a></li>          

          <li><a href="message.php">Message</a></li>
          <li><a href="donatestudent.php">Donate</a></li>
          <li><a href="notiview.php">Notification</a></li>
